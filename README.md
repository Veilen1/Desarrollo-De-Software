...
| **US-11** | EP-03 | Como sistema, quiero enviar alertas al docente, para evitar retrasos en la carga de notas. | 1. **Dado** el plazo próximo a vencer, **Cuando** no hay carga, **Entonces** se envía un recordatorio por mail.<br>2. **Dado** la carga completa, **Cuando** llega la fecha límite, **Entonces** no se envía ninguna alerta. | 3 | S | 4 |
| **US-12** | EP-04 | Como conducción, quiero visualizar el desgranamiento, para analizar la deserción por cohorte. | 1. **Dado** el filtro por cohorte, **Cuando** se genera el reporte, **Entonces** muestra el % de bajas.<br>2. **Dado** una consulta global, **Cuando** se procesa, **Entonces** permite comparar carreras de posgrado. | 8 | C | 5 |
| **US-13** | EP-01 | Como conducción, quiero abrir o cerrar periodos de inscripción, para controlar el ingreso. | 1. **Dado** el estado "Cerrado", **Cuando** se accede al link, **Entonces** el usuario ve un aviso de cierre.<br>2. **Dado** el estado "Abierto", **Cuando** se accede, **Entonces** el formulario de inscripción está activo. | 2 | M | 1 |
| **US-14** | EP-02 | Como conducción, quiero recibir alertas sobre vencimientos, para prevenir la pérdida de regularidad. | 1. **Dado** un seminario próximo a vencer, **Cuando** se abre el panel, **Entonces** se resalta en rojo.<br>2. **Dado** un seminario ya aprobado, **Cuando** se verifica el plazo, **Entonces** no se genera alerta. | 5 | S | 4 |
